...
const TodoInput = ({getTodo}) => {
  ...
  const handleAddTodo = async()=>{
    ...
    await axios.post("http://localhost:3000/todo/addTodo",{title:todoValue})
  ...
  return (
    <div className="flex gap-3 mb-6">
      ...
      />
      <button onClick={handleAddTodo} className="cursor-pointer px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition">
        Add
      </button>
    </div>
  );
